...
const ModalDeletePromo = ({ open, handleClose, promoId, onUpdate }) => {
  const handleDelete = async (e) => {
    e.preventDefault();

    try {
      const res = await instanceAdmin.delete(`/delete/promo/${promoId}`);
      ...
      // Log detail error
      console.error("Gagal menghapus promo. Detail error:");
        ...
        <div>
          ...
          >
            ...
            <div className="px-5 pb-2">
              <h2 className="text-2xl font-bold ">Hapus Promo</h2>
            </div>
          </div>
          ...
          <div className="px-6 mt-5 flex flex-col justify-center items-center pb-6">
            ...
            <p className="text-center mx-14 text-sm text-graytext">
              Promo yang dihapus tidak dapat dipulihkan. Pastikan Anda telah
