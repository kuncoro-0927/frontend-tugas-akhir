    ...
    <section className="flex 2xl:mx-32 ">
      ...
      <div className="md:p-8 mt-5 mx-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="mt-6 space-y-6  w-[650px] lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10 lg:mt-7">
            <FormInput
              type="text"
              name="firstname"
              label="Nama depan"
          ...
          <div className="flex items-center ">
            <button
              type="submit"
              className="px-4 bg-black text-white rounded-md mt-5 lg:mt-7 py-2 mr-5 lg:text-base lg:font-medium flex justify-center hover:-translate-y-1 duration-300 $"
            >
              Simpan
            </button>
          </div>
