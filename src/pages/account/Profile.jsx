        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="mt-6 space-y-6 lg:w-[650px] lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10 lg:mt-7">
            ...
            <FormInput
              ...
              name="province"
              label="Provinsi"
              error={isSubmitted && error.province}
              helperText={
                isSubmitted && error.province
            ...
            <FormInput
              ...
              name="postal_code"
              label="Kode Pos"
              error={isSubmitted && error.postal_code}
              helperText={
                isSubmitted && error.postal_code
